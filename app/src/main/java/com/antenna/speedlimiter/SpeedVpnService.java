...
public class SpeedVpnService extends VpnService {
    private static final String TAG = "SpeedVpnService";
    ...
    private static final String MAPPED_DNS_NETWORK = "100.64.0.0";
    private static final String MAPPED_DNS_NETMASK = "255.192.0.0";
    private static final int TASK_STACK_SIZE = 86016;
    ...
    private void startEverything(long downloadKbps, long uploadKbps) throws Exception {
        ...
        Log.i(TAG, "Using underlying network: " + underlying);
        ...
        Log.i(TAG, "Establishing TUN interface");
        ...
        Log.i(TAG, "Starting hev-socks5-tunnel with config " + configFile.getAbsolutePath());
